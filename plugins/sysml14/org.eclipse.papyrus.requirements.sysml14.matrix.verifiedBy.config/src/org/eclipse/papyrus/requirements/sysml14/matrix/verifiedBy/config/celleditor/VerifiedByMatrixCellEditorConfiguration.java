...
package org.eclipse.papyrus.requirements.sysml14.matrix.verifiedBy.config.celleditor;
...
public class VerifiedByMatrixCellEditorConfiguration implements ICellAxisConfiguration {
	...
	public boolean handles(Table table, Object axisElement) {
		if (table.getTableConfiguration().getName().equals("VerifiedByMatrixSysML14")) {
