...
/**
 * 
 * Creates a derived requirement from a set of requirements with a concatenated
 * text
 *
 */
public class InitDerivedReqCommand extends RecordingCommand {
	...
	protected void doExecute() {
		...
		final Profile sysmlReqProfile = UMLUtil.getProfile(sysmlPackage.eINSTANCE, owner);
