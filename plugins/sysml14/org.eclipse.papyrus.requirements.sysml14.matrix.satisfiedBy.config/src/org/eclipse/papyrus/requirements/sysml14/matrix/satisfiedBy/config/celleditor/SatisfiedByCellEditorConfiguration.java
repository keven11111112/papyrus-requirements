...
package org.eclipse.papyrus.requirements.sysml14.matrix.satisfiedBy.config.celleditor;
...
public class SatisfiedByCellEditorConfiguration implements ICellAxisConfiguration {
	 ...
	 */
	private static final String ID = "org.eclipse.papyrus.requirements.sysml14.matrix.satisfiedBy.config.celleditor.SatisfyByCellEditorConfiguration.CheckBox";//$NON-NLS-1$
	...
	public boolean handles(Table table, Object axisElement) {
		if(table.getTableConfiguration().getName().equals("SatisfiedByMatrixSysML14")){
