...
package org.eclipse.papyrus.requirements.sysml14.matrix.common.celleditor;
...
public class BooleanMatrixCellEditorConfiguration implements ICellAxisConfiguration {
	...
	public boolean handles(Table table, Object axisElement) {
		if (table.getTableConfiguration().getType().equals("RequirementsBooleanMatrixSysML14")) {
