 ...
 *
 *****************************************************************************/
package org.eclipse.papyrus.requirements.sysml14.matrix.common.utils;
...
public class IntersectionEditingUtil {
	/**
	 ...
	 * @param type
	 */
	public static void createRelationshipInIntersection(TransactionalEditingDomain domain, Object row, Element colUMLElement,
			IElementType type) {
