 ...
 * @generated
 */
public class ExtendedSysMLProfileSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ExtendedSysMLProfileSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtendedSysMLProfilePackage.REQUIREMENTS_PACKAGE: {
